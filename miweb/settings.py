...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME'),      # Lee del .env
        'USER': os.getenv('DB_USER'),      # Lee del .env
        'PASSWORD': os.getenv('DB_PASSWORD'), # Lee del .env
        'HOST': os.getenv('DB_HOST'),      # Lee del .env
        'PORT': os.getenv('DB_PORT'),      # Lee del .env
        'OPTIONS': {
